    ...
    >
      <div className="d-flex flex-row my-auto mx-auto justify-content-between align-items-center">
        <div className="">
          ...
          >
            Exchange anything online with VLX
          </p>
          <p
            className="text-white text-center"
            style={{
          ...
          >
            VLX lets you connect to network of leading market places accross the{" "}
            <span className="text-danger font-weight-bold">GLOBE</span>
          </p>
        ...
        <div className="">
          <div className="w-100">
            <img className="w-75" src="/landing.svg" alt="landing image" />
          </div>
        </div>
      </div>
    </div>
