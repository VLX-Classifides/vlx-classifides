...
class UpdateProduct extends Component {
    ...
    addImageToProduct = async (id) => {
        ...
        const url = api.developmentServer + "/update/product/" + id + "/assign-image";
        await axios
            .post(url, fd, {
                            ...
                            <div className="d-flex flex-row mt-2">
                                <div className="mx-2">
                                    <input
                                        ...
                                        onChange={(e) => { this.setState({ old: true }) }}
                                    />{" "}
                                    Yes
                                </div>
                                <div className="mx-2">
                                    <input
                                        ...
                                        id="oldno"
                                        checked={!this.state.old}
                                        onChange={(e) => { this.setState({ old: false }) }}
                                    />{" "}
                                    No
                                </div>
                            </div>
                            ...
                            <>
                                <div className="my-2">
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => { this.setState({ usedyr: e.target.value }) }}
                                    />
                                </div>
                                <div className="my-2">
                                    ...
                                    <select
                                        ...
                                        onChange={(e) => { this.setState({ condi: e.target.value }) }}
                                    >
                                        <option value="" disabled selected></option>
                                    ...
                                    <div className="d-flex flex-row mt-2">
                                        <div className="mx-2">
                                            <input
                                                ...
                                                onChange={(e) => { this.setState({ negotiable: true }) }}
                                            />{" "}
                                            Yes
                                        </div>
                                        <div className="mx-2">
                                            <input
                                                ...
                                                id="negotiableno"
                                                checked={!this.state.negotiable}
                                                onChange={(e) => { this.setState({ negotiable: false }) }}
                                            />{" "}
                                            No
                                        </div>
                                    </div>
