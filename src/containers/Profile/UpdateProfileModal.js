...
class UpdateProfileModal extends Component {
    ...
    updateProfile = async () => {
        ...
        else if (this.state.contact === null || this.state.contact.length !== 10) {

            toast.warning("Check Contact No");
        }
        else if (this.props.user.role === "seller" && this.state.creditCard.length !== 16) {
            ...
            <Modal size="lg" isOpen={this.props.show} toggle={this.props.toggle}>
                ...
                <ModalFooter>
                    <div className="d-flex flex-row justify-content-center">
                        ...
                        <button className="btn btn-success mx-1" onClick={this.updateProfile}>
                            Update
                        </button>
                    </div>
                </ModalFooter>
